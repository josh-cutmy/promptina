      ...
      if (isSignUp) {
        ...
        if (error) {
          if (error.message.includes('422')) {
            throw new Error('Please check your email format and ensure it\'s valid. Email confirmation may be required.')
          }
          throw error
        }
        ...
        if (data.session) {
          ...
          // Use router.push with refresh to update server state
          router.push('/')
          router.refresh()
        } else {
